<template>
  <van-cell class="comment-item">
    ...
    <div slot="title" class="title-wrap">
      ...
      <van-button @click="onLikeClick" :class="{liked:comment.is_liking }" :loading="commentLoading" class="like-btn" :icon="comment.is_liking ? 'good-job': 'good-job-o'">{{comment.like_count||'赞'}}</van-button>
    </div>
